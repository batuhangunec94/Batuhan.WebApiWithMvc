...
namespace Batuhan.WebApi.Migrations
{
    ...
    [Migration("20220828220609_mssqlMigration")]
            ...
            modelBuilder.Entity("Batuhan.WebApi.Entities.Car", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 26, 1, 6, 9, 342, DateTimeKind.Local).AddTicks(6540),
                            Hp = 450,
                            Name = "Bmw M8",
                            Price = 60000m
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 17, 1, 6, 9, 342, DateTimeKind.Local).AddTicks(7426),
                            Hp = 550,
                            Name = "Ford Mustang",
                            Price = 50000m
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 7, 24, 1, 6, 9, 342, DateTimeKind.Local).AddTicks(7436),
                            Hp = 432,
                            Name = "Porche",
                            Price = 130000m
                        });
